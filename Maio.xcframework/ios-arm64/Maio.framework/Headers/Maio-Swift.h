...
@class MaioBannerView;

SWIFT_PROTOCOL("_TtP4Maio18MaioBannerDelegate_")
@protocol MaioBannerDelegate
@optional
- (void)didLoad:(MaioBannerView * _Nonnull)ad;
- (void)didFailToLoad:(MaioBannerView * _Nonnull)ad errorCode:(NSInteger)errorCode;
- (void)didMakeImpression:(MaioBannerView * _Nonnull)ad;
- (void)didClick:(MaioBannerView * _Nonnull)ad;
- (void)didLeaveApplication:(MaioBannerView * _Nonnull)ad;
- (void)didFailToShow:(MaioBannerView * _Nonnull)ad errorCode:(NSInteger)errorCode;
@end


SWIFT_CLASS("_TtC4Maio14MaioBannerSize")
@interface MaioBannerSize : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MaioBannerSize * _Nonnull banner;)
+ (MaioBannerSize * _Nonnull)banner SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MaioBannerSize * _Nonnull bigBanner;)
+ (MaioBannerSize * _Nonnull)bigBanner SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MaioBannerSize * _Nonnull mediumRectangle;)
+ (MaioBannerSize * _Nonnull)mediumRectangle SWIFT_WARN_UNUSED_RESULT;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC4Maio14MaioBannerView")
@interface MaioBannerView : UIView
@property (nonatomic, copy) IBInspectable NSString * _Nullable zoneId;
@property (nonatomic, strong) MaioBannerSize * _Nullable size;
@property (nonatomic, weak) id <MaioBannerDelegate> _Nullable delegate;
@property (nonatomic, weak) UIViewController * _Nullable rootViewController;
@property (nonatomic, readonly) BOOL isReady;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithZoneId:(NSString * _Nullable)zoneId size:(MaioBannerSize * _Nullable)size OBJC_DESIGNATED_INITIALIZER;
- (void)destroy;
- (void)didMoveToWindow;
- (void)pause;
- (void)resume;
- (void)loadWithTestMode:(BOOL)testMode bidData:(NSString * _Nullable)bidData;
@end
